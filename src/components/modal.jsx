...
// image1
  ...
  const onChangeFile = (event) => {
    ...
    setimageUrl(BASE_URL + '/uploads/' + event.target.files[0].name) 
    console.log(BASE_URL + '/uploads/' + event.target.files[0].name) 
...
const [selectedFile2, setselectedFile2] = React.useState('')
  ...
  const onChangeFile2 = (event) => {
    ...
    setimageUrl2(BASE_URL + '/uploads/' + event.target.files[0].name) 
...
const onChangeFile3 = (event) => {
  ...
  setimageUrl3(BASE_URL + '/uploads/' + event.target.files[0].name) 
...
const [selectedFile4, setselectedFile4] = React.useState('')
  ...
  const onChangeFile4 = (event) => {
    ...
    setimageUrl4(BASE_URL + '/uploads/' + event.target.files[0].name) 
...
const onChangeFile5 = (event) => {
  ...
  setimageUrl5(BASE_URL + '/uploads/' + event.target.files[0].name) 
